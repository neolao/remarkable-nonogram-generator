...
## Acceptance Criteria
- [ ] Creating a grid with a valid width, height, and cell values returns a Nonogram object
- [ ] Creating a grid with a non-positive width or height throws a clear validation error
- [ ] Creating a grid larger than the maximum size that fits a reMarkable-2 page throws a clear validation error
- [ ] The grid type has no dependency on rendering, persistence, or any Node/browser-specific runtime
