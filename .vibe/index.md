...
- [`modules/web-server.md`](.vibe/modules/web-server.md) — Fastify server + static frontend, exposes the reMarkable connection flow, the full nonogram list/create/get/update/delete API, and stateless SVG preview / PDF generation endpoints (configurable listen port via `PORT`)
