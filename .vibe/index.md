...
- [`modules/nonogram-domain.md`](.vibe/modules/nonogram-domain.md) — core nonogram grid data model (filled/empty cells), validated against reMarkable 2 page size constants
