...
- [`modules/web-server.md`](.vibe/modules/web-server.md) — Fastify server + static frontend, exposes the reMarkable connection/send flow, the full nonogram list/create/get/update/delete API, stateless SVG preview / PDF generation endpoints, a home page listing/creating/deleting saved nonograms, and a minimal editor page stub (configurable listen port via `PORT`)
