...
- [`modules/nonogram-persistence.md`](.vibe/modules/nonogram-persistence.md) — file-based save/list/load/delete of nonograms, one JSON file per id, backs the `GET /api/nonograms` listing route
- [`modules/web-server.md`](.vibe/modules/web-server.md) — Fastify server + static frontend, exposes the reMarkable connection flow and the nonogram listing route
